...
syn keyword cType G4int G4double G4float G4string
syn keyword cType G4Material G4MaterialPropertiesTable G4OpticalSurface
syn keyword cType G4LogicalSkinSurface G4LogicalBorderSurface
syn keyword cType G4ThreeVector 
if !exists("c_no_cern_root")
   ...
   syn keyword	cType		TF1 TF2 TF3 TCut TObjArray
   syn keyword	cType		THStack TGraph TGraph2D TGraphErrors TCanvas TRandom TLimit TLatex
   syn keyword	cType		TNtuple TObject TTree TIter TKey TRandom2 TShape TPad TMacro TText
   ...
   syn keyword	cType           TVirtualFitter TFitResultPtr TPaveText
   syn keyword	cConstant       kBlack kRed kPink kBlue kMagenta kViolet kAzure kCyan kTeal kGreen kSpring kYellow
   ...
   syn keyword	cConstant       kTRUE kFALSE vector 
   ...
   syn keyword	cSpecial        gClient gMinuit gHtml gInterpreter
endif
