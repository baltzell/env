...
hi Normal		ctermbg=Black  ctermfg=White guibg=Black		 guifg=grey90
...
hi StatusLine term=reverse,bold cterm=reverse,bold gui=underline,bold guibg=yellow guifg=black
